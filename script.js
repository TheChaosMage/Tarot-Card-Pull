...
const Deck = {
    ...
    Six_of_Wands:["Six of Wands","victory, success, public rewardReversed: excess pride, lack of recognition, punishment","Cards/minor_arcana_wands_6.png"],
    Seven_of_Wands:["Seven of Wands","perseverance, defensive, maintaining control , overwhelmed","Cards/minor_arcana_wands_7.png"],
    Eight_of_Wands:["Eight of Wands","rapid action, movement, quick decisions Reversed: panic, waiting, slowdown","Cards/minor_arcana_wands_8.png"],
    ...
    The_Knight_of_Wands:["The Knight of Wands","action, adventure, fearlessnes Reversed: anger, impulsiveness, recklessness","Cards/minor_arcana_wands_knight.png"],
